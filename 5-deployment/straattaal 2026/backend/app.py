...
FRONTEND_FOLDER = Path(__file__).resolve().parent / "static"  # => /app/backend/static
...
app.mount("/static", StaticFiles(directory=str(FRONTEND_FOLDER), html=True), name="static")
